...
const New_password = () => {
  ...
  return (
    <div className="  flex flex-col justify-center items-center text-black h-screen shadow-2xl  ">
      <div className="flex flex-col justify-center items-center gap-4 bg-gray-100 w-120 h-50 rounded-xl shadow-lg">
        ...
        <div className="flex">
          <input
            ...
            value={password}
            className="text-zinc-950 border-2 border-blue-500 pl-2 bg-white h-9 rounded-l-md w-70 "
            ref={copyPassword}
          />
